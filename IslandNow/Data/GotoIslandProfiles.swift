...
enum GotoIslandProfiles {
    ...
    private static let fukue = IslandProfile(
        ...
        backgroundCredit: "Photo: Hiroaki Kaneko / Wikimedia Commons（堂崎天主堂・CC BY-SA 3.0）",
    ...
    private static let hisaka = IslandProfile(
        ...
        backgroundCredit: "Photo: Marine-Blue / Wikimedia Commons（旧五輪教会・CC BY-SA 4.0）",
    ...
    private static let naru = IslandProfile(
        ...
        backgroundCredit: "Photo: Indiana jo / Wikimedia Commons（江上天主堂・CC BY-SA 4.0）",
        placeSearchRadiusMeters: 8_000,
    ...
    private static let wakamatsu = IslandProfile(
        ...
        backgroundCredit: "Photo: Ebizur / Wikimedia Commons（若松大橋・CC BY-SA 3.0）",
        placeSearchRadiusMeters: 8_000,
    ...
    private static let nakadori = IslandProfile(
        ...
        backgroundCredit: "Photo: Sapphire123 / Wikimedia Commons（青嵐教会・CC BY-SA 3.0）",
