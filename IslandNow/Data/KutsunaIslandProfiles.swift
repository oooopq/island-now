...
enum KutsunaIslandProfiles {
    ...
    private static let nakajima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（中島・愛媛）／表示時に暗色グラデーションを追加",
    ...
    private static let gogoshima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（興居島・愛媛）／表示時に暗色グラデーションを追加",
    ...
    private static let muzukijima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（睦月島・愛媛）／表示時に暗色グラデーションを追加",
    ...
    private static let nogutsunajima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（野忽那島・愛媛）／表示時に暗色グラデーションを追加",
    ...
    private static let nuwajima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（怒和島・愛媛）／表示時に暗色グラデーションを追加",
        placeSearchRadiusMeters: 5_000,
    ...
    private static let tsuwajishima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（津和地島・愛媛）／表示時に暗色グラデーションを追加",
        placeSearchRadiusMeters: 4_000,
    ...
    private static let futagamijima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（二神島・愛媛）／表示時に暗色グラデーションを追加",
    ...
    private static let tsurushima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（釣島・愛媛）／表示時に暗色グラデーションを追加",
    ...
    private static let aijima = IslandProfile(
        ...
        backgroundCredit: "Photo: Wikimedia Commons（安居島・愛媛）／表示時に暗色グラデーションを追加",
        placeSearchRadiusMeters: 2_000,
